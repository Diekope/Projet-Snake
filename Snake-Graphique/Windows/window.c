...
int fenetre_acceuil() {
    ...
    TTF_Font* font = TTF_OpenFont("Fonts/GrinchedRegular.ttf", 150); // L'int à la fin est sa taille 
    TTF_Font* font1 = TTF_OpenFont("Fonts/04B_30__.ttf", 40); // Play
    TTF_Font* font2 = TTF_OpenFont("Fonts/04B_30__.ttf", 25); // Play
    TTF_Font* font3 = TTF_OpenFont("Fonts/04B_30__.ttf", 10); // Quitter
    if (!font || !font2 || !font3) {
...
int partie() {
    ...
    // ==============
    // ===On_importe_la_police===
    TTF_Font* font = TTF_OpenFont("Fonts/GrinchedRegular.ttf", 100); // L'int à la fin est sa taille
    TTF_Font* font2 = TTF_OpenFont("Fonts/04B_30__.ttf", 26); // Play - Load - Back
...
int pauseWindow(int score, Mix_Music *music){
    ...
    // ===On_importe_la_police===
    TTF_Font* font = TTF_OpenFont("Fonts/GrinchedRegular.ttf", 100); // L'int à la fin est sa taille
    TTF_Font* font1 = TTF_OpenFont("Fonts/GrinchedRegular.ttf", 65); //
    TTF_Font* font2 = TTF_OpenFont("Fonts/04B_30__.ttf", 28); // Main Menu - Replay

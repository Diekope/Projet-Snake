...
int fenetre_acceuil(){
    ...
    TTF_Font* font = TTF_OpenFont("/Users/ValQuiTravaille/Desktop/Université/L2/Programmation/Projet Snake/git/Projet-Snake/menus_Val/TEST/affiche_elements/Fonts/Arial Unicode.ttf", 256); // L'int à la fin est sa taille
    TTF_Font* font2 = TTF_OpenFont("/Users/ValQuiTravaille/Desktop/Université/L2/Programmation/Projet Snake/git/Projet-Snake/menus_Val/TEST/affiche_elements/Fonts/Arial Unicode.ttf", 30); // L'int à la fin est sa taille
    ...
    Button autre = {{100, 100, 200, 50}, "Autre"};
    autre.rect.x = (lg - play.rect.w) / 2;
    autre.rect.y = play.rect.y+150;
    ...
    while (running) {
        ...
        // ===La_couleur===
        SDL_SetRenderDrawColor(renderer, 0, 86, 27, 255);
